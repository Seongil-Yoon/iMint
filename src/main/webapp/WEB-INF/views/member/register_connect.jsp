...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/member/member_register_new.css">
</head>
...
<div class="container">
 	...
 	<div class = "item">
 		<input type = text class="pin" name = "mbLocationOrGuard" placeholder = "보호자 닉네임을 입력해주세요." >
 	</div>
 	<div class = "item">
 		<input type = text class="pin" name = "guardPin" placeholder = "보호자 계정 마이페이지 내 8자리 Pin번호를 입력해주세요."> <!-- 보호자 닉네임 == Pin인지 확인하기  -->
 	</div>
 	<br>
 	<div class = "item">
