...
public interface IChatDAO {
	...
	// <1> 채팅내용 저장
	/*
	 * // 1. 최초 채팅하기 버튼 클릭시 채팅방 정보 db에 저장 public int
	 * insertChatRoomInitInfo(ChatRoomDTO dto);
	 * 
	 * // 2. 채팅하고 뒤로가기버튼 눌렀을시 채팅메세지 정보 db에 저장 public int
	 * insertUpdateChatMessageInfo(ChatMessageDTO dto);
	 * 
	 ...
	 * 판매자, 판매자인경우 - 구매자), 가격흥정여부 public ChatRoomInfoDTO bringChatRoomInfo(int
	 * chatRoomId);
	 * 
	 ...
	 * 
	 * // <4> 채팅방 삭제 // 6. 채팅목록에서 다중선택으로 채팅방 삭제 public List<ChatRoomDTO>
	 * deleteChatRoom(int chatRoomId[]);
	 */
	/*
 2. @Mapper
